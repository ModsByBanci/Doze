...
public class Config {
    ...
    static {
        ...
        MINIMUM_LIGHT = BUILDER
                .comment("Minimum light level required for sleep (0-15)")
        ...
        HEALTH_PER_HOUR = BUILDER
                ...
                .defineInRange("healthPerHour", 1, 0, Integer.MAX_VALUE);

        HUNGER_COST = BUILDER
                .comment("doze.configuration.hungerCost.description")
                .translation("doze.configuration.hungerCost")
                .defineInRange("hungerCost", 1, 0, Integer.MAX_VALUE);
        ...
        BEDS_EXPLODE = BUILDER
                .comment("Whether beds explode in dimensions like the Nether")
                .translation("doze.configuration.bedsExplode")
                .define("bedsExplode", false);
